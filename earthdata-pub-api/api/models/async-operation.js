...
const { ecs, s3 } = require('earthdata-pub-api/aws-client/services');
...
class AsyncOperation extends Manager {
   ...
   * @param {string} params.stackName - the EarthdataPub stack name
   * @param {string} params.systemBucket - the name of the EarthdataPub system bucket
