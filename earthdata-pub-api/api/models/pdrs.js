...
class Pdr extends Manager {
   ...
   *
   * @param {Object} earthdatapubMessage - earthdata-pub message object
   */
  async storePdrFromEarthdataPubMessage(earthdatapubMessage) {
    const pdrRecord = this.generatePdrRecord(earthdatapubMessage);
