 ...
 * @param {string} index - name of the index to create if does not exist, defaults to 'earthdata-pub'
 * @param {string} alias - alias name for the index, defaults to 'earthdata-pub'
 * @returns {Promise} undefined
 */
async function bootstrapElasticSearch(host, index = 'earthdata-pub', alias = defaultIndexAlias) {
  if (!host) return;
