...
module.exports = {
  ...
  entry: {
    ...
    userSecretsMigration: './lambdas/userSecretsMigration.js',
    publishExecutions: './lambdas/publish-executions.js',
    publishGranules: './lambdas/publish-granules.js',
    publishSubmissions: './lambdas/publish-submissions.js',
    ...
    verifyUserSecretsMigration: './lambdas/verifyUserSecretsMigration.js',
