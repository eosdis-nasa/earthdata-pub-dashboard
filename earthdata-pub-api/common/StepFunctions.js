...
const describeExecution = aws.improveStackTrace(
  aws.retryOnThrottlingException(
    (params) => {
      deprecate('earthdata-pub-api/common/StepFunctions.describeExecution', '1.17.0', 'earthdata-pub-api/aws-client/StepFunctions.describeExecution');
...
const describeStateMachine = aws.improveStackTrace(
  aws.retryOnThrottlingException(
    (params) => {
      deprecate('earthdata-pub-api/common/StepFunctions.describeStateMachine', '1.17.0', 'earthdata-pub-api/aws-client/StepFunctions.describeStateMachine');
...
const executionExists = (executionArn) => {
  deprecate('earthdata-pub-api/common/StepFunctions.executionExists', '1.17.0', 'earthdata-pub-api/aws-client/StepFunctions.executionExists');
...
const getExecutionHistory = aws.improveStackTrace(
  aws.retryOnThrottlingException(
    async (
      ...
      deprecate('earthdata-pub-api/common/StepFunctions.getExecutionHistory', '1.17.0', 'earthdata-pub-api/aws-client/StepFunctions.getExecutionHistory');
...
const listExecutions = aws.improveStackTrace(
  aws.retryOnThrottlingException(
    (params) => {
      deprecate('earthdata-pub-api/common/StepFunctions.listExecutions', '1.17.0', 'earthdata-pub-api/aws-client/StepFunctions.listExecutions');
