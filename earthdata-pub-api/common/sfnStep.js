...
class SfnStep {
  ...
  static async parseStepMessage(stepMessage, stepName) {
    deprecate('earthdata-pub-api/common/sfnStep/SfnStep.parseStepMessage', '1.17.0', '@cumulus/integration-tests/sfnStep/SfnStep.parseStepMessage');
...
class LambdaStep extends SfnStep {
  constructor() {
    super();
    deprecate('earthdata-pub-api/common/sfnStep/LambdaStep', '1.17.0', '@cumulus/integration-tests/sfnStep/LambdaStep');
...
class ActivityStep extends SfnStep {
  constructor() {
    super();
    deprecate('earthdata-pub-api/common/sfnStep/ActivityStep', '1.17.0', '@cumulus/integration-tests/sfnStep/ActivityStep');
