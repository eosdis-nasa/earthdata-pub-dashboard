...
exports.getLocalstackEndpoint = (identifier) => {
  deprecate('earthdata-pub-api/common/test-utils/getLocalstackEndpoint', '1.17.0', 'earthdata-pub-api/aws-client/test-utils/getLocalstackEndpoint');
...
exports.testAwsClient = (Service, options) => {
  deprecate('earthdata-pub-api/common/test-utils/testAwsClient', '1.17.0', 'earthdata-pub-api/aws-client/test-utils/testAwsClient');
