...
const errors = require('earthdata-pub-api/errors');
...
exports.s3 = (options) => {
  deprecate('earthdata-pub-api/common/aws/s3', '1.17.0', 'earthdata-pub-api/aws-client/services/s3');
  return awsClient(AWS.S3, '2006-03-01')(options);
};
exports.dynamodb = (options) => {
  deprecate('earthdata-pub-api/common/aws/dynamodb', '1.17.0', 'earthdata-pub-api/aws-client/services/dynamodb');
  return awsClient(AWS.DynamoDB, '2012-08-10')(options);
};
exports.dynamodbDocClient = (options) => {
  deprecate('earthdata-pub-api/common/aws/dynamodbDocClient', '1.17.0', 'earthdata-pub-api/aws-client/services/dynamodbDocClient');
...
exports.s3ObjectExists = (params) => {
  deprecate('earthdata-pub-api/common/aws/s3ObjectExists', '1.17.0', 'earthdata-pub-api/aws-client/S3/s3ObjectExists');
...
exports.s3PutObject = exports.improveStackTrace(
  (params) => {
    deprecate('earthdata-pub-api/common/aws/s3PutObject', '1.17.0', 'earthdata-pub-api/aws-client/S3/s3PutObject');
...
exports.getS3Object = exports.improveStackTrace(
  (Bucket, Key, retryOptions = { retries: 0 }) =>
    pRetry(
      async () => {
        deprecate('earthdata-pub-api/common/aws/getS3Object', '1.17.0', 'earthdata-pub-api/aws-client/S3/getS3Object');
        try {
...
exports.headObject = exports.improveStackTrace(
  (Bucket, Key) => {
    deprecate('earthdata-pub-api/common/aws/headObject', '1.17.0', 'earthdata-pub-api/aws-client/S3/headObject');
...
exports.deleteS3Object = exports.improveStackTrace(
  (bucket, key) => {
    deprecate('earthdata-pub-api/common/aws/deleteS3Object', '1.17.0', 'earthdata-pub-api/aws-client/S3/deleteS3Object');
...
exports.deleteS3Files = (s3Objs) => {
  deprecate('earthdata-pub-api/common/aws/deleteS3Files', '1.17.0', 'earthdata-pub-api/aws-client/S3/deleteS3Files');
  return pMap(
    s3Objs,
...
exports.recursivelyDeleteS3Bucket = exports.improveStackTrace(
  async (bucket) => {
    deprecate('earthdata-pub-api/common/aws/recursivelyDeleteS3Bucket', '1.17.0', 'earthdata-pub-api/aws-client/S3/recursivelyDeleteS3Bucket');
...
exports.listS3ObjectsV2 = async (params) => {
  deprecate('earthdata-pub-api/common/aws/listS3ObjectsV2', '1.17.0', 'earthdata-pub-api/aws-client/S3/listS3ObjectsV2');
...
exports.parseS3Uri = (uri) => {
  deprecate('earthdata-pub-api/common/aws/parseS3Uri', '1.17.0', 'earthdata-pub-api/aws-client/S3/parseS3Uri');
...
exports.getExecutionArn = (stateMachineArn, executionName) => {
  deprecate('earthdata-pub-api/common/aws/getExecutionArn', '1.17.0', 'earthdata-pub-api/aws-client/StepFunctions/getExecutionArn');
...
exports.pullStepFunctionEvent = async (event) => {
  deprecate('earthdata-pub-api/common/aws/pullStepFunctionEvent', '1.17.0', 'earthdata-pub-api/aws-client/StepFunctions/pullStepFunctionEvent');
