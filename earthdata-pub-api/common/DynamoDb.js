...
const get = improveStackTrace(
  async ({
    ...
    deprecate('earthdata-pub-api/common/DynamoDb.get', '1.17.0', 'earthdata-pub-api/aws-client/DynamoDb.get');
...
const scan = improveStackTrace(
  async ({
    ...
    deprecate('earthdata-pub-api/common/DynamoDb.scan', '1.17.0', 'earthdata-pub-api/aws-client/DynamoDb.scan');
