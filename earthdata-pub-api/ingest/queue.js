...
const { sendSQSMessage } = require('earthdata-pub-api/aws-client/SQS');
const { getExecutionArn } = require('earthdata-pub-api/aws-client/StepFunctions');

const {
  buildQueueMessageFromTemplate,
  getQueueNameByUrl
} = require('earthdata-pub-api/common/message');
