# earthdata-pub-api/ingest

earthdata-pub-api/ingest is a collection of modules for discovering and ingesting data.
...
```bash
npm install earthdata-pub-api/ingest
```
...
All modules are accessible using require: `require('earthdata-pub-api/ingest/<MODULE_NAME>')` or import: `import <MODULE_NAME> from 'earthdata-pub-api/ingest/<MODULE_NAME>'`.
