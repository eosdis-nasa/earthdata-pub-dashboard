...
import { getExecutionStatus, getEarthdatapubInstanceMetadata } from '../../actions';
...
class ExecutionStatus extends React.Component {
  ...
  render () {
    ...
    const { executionStatus, earthdatapubInstance } = this.props;
    ...
    const metaAccessors = [
      ...
      },
      {
        ...
        accessor: d => {
          ...
          return get(outputJson.earthdatapub_meta, 'asyncOperationId');
        }
      },
      {
        label: 'Started',
      ...
      },
      {
        ...
        accessor: d => {
          ...
          const parent = get(input.earthdatapub_meta, 'parentExecutionArn');
          if (parent) {
      ...
      },
      {
        ...
        property: 'executionArn',
        accessor: d => {
          const kibanaLink = kibanaExecutionLink(earthdatapubInstance, d);
