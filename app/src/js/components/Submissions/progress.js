...
// defines the order in which the submissions meta bar appears
...
class Progress extends React.Component {
  ...
  getItem (key) {
    return this.props.submissions.find(count => count.key === key);
  }
...
Progress.propTypes = { submissions: PropTypes.array };
