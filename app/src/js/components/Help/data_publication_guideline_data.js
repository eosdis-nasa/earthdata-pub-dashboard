...
const data_publication_guidelines_data = {
    ...
    "paragraphs":[
      {
         "text":"NASA's Earth Science Division (ESD) has a long-standing commitment to the full and open sharing of all data with research and applications communities, private industry, academia, and the general public, as defined in the <a title='ESD Data and Information Guidance' href='https://www.earthdata.nasa.gov/engage/open-data-services-software-policies/data-information-guidance' class='ext' target=_blank>ESD Data and Information Guidance</a>. For most ESD-funded researchers, the designated repository will be a NASA Distributed Active Archive Center (<a title='DAAC' href='https://www.earthdata.nasa.gov/eosdis/daacs' class='ext' target=_blank>DAAC</a>). NASA DAACs are managed by NASA's Earth Science Data and Information System (<a title='ESDIS' href='https://www.earthdata.nasa.gov/esdis' class='ext' target=_blank>ESDIS</a>) Project, part of NASA's Earth Science Data System (<a title='ESDS' href='https://www.earthdata.nasa.gov/esds' class='ext' target=_blank>ESDS</a>) Program."
      },
       {
       ...
       {
          "text":"All data published at DAACs must be formally assigned by NASA to the DAAC. For more information on this process, see the <a title='Data Accession Process' href='/data_publication_guidelines#accession'>Data Accession Process</a> section."
       },
       {
          "heading":"<h2 class='display-4' id='daacs'>The NASA DAACs<hr></h2>",
          "text":"The table below lists the 12 DAACs and their primary scientific disciplines. A link to the DAAC website is provided where additional information, including how to contact the DAAC, can be found.",
          "table":{
             ...
             "rows":[
                {
                   "number":1,
                   "columns":[
                      "<a title='Alaska Satellite Facility (ASF)' href='http://www.asf.alaska.edu/' class='ext' target=_blank>Alaska Satellite Facility (ASF)</a>",
                ...
                },
                {
                   "number":2,
                   "columns":[
                      "<a title='Atmospheric Science Data Center (ASDC)' href='https://eosweb.larc.nasa.gov/' class='ext' target=_blank>Atmospheric Science Data Center (ASDC)</a>",
                ...
                },
                {
                   "number":8,
                   "columns":[
                      "<a title='National Snow and Ice Data Center DAAC (NSIDC DAAC)' href='https://nsidc.org/daac' class='ext' target=_blank>National Snow and Ice Data Center DAAC (NSIDC DAAC)</a>",
       ...
       {
          "text":"For more information on the DAACs, see the <a title='Earthdata EOSDIS DAACs' href='https://earthdata.nasa.gov/eosdis/daacs' class='ext' target=_blank>Earthdata EOSDIS DAACs</a> page."
       },
       {
       ...
       },
       {
          ...
          "text":"All data archived and distributed at DAACs must be formally assigned by NASA to the DAAC. Data from NASA science missions and some NASA research programs, as well as community-produced data, are directly assigned to a DAAC by NASA ESDIS."
       },
       {
          "text":"The NASA Data Accession process is initiated by submitting a Data Accession request in Earthdata Pub. During the process, an assessment of the following will be conducted:",
          "list":[
             "The data product’s alignment with the <a title='data acceptance guidelines' href='data_publication_guidelines#acceptance'  class='ext' target=_blank>Data Acceptance Guidelines</a>",
             "The alignment of data file contents and structure with <a title='NASA standards' href='https://www.earthdata.nasa.gov/esdis/esco/standards-and-practices' class='ext' target=_blank>NASA standards</a>",
             "The appropriate <a title='Level of Service' href='https://earthdata.nasa.gov/engage/submit-data/level-service-model' class='ext' target=_blank>Level of Service</a> and the DAAC resources necessary to achieve the Level of Service"
          ]
       },
       {
          "text":"During the assessment, you may be contacted for additional information or obtain feedback from a User Working Group, an external advisory group representing the DAAC’s scientific discipline. This information will be assessed for approval. The time required to assign your data product to a DAAC will vary, but it can take several weeks."
       },
       {
          "text":"You will be notified of the result of your Data Accession Request. If approved, you can work with the DAAC to publish your data. If not approved, you will be advised of the reasons for the decision."
       },
       {
             ...
             "rows":[
                {
                   ...
                   "columns":[
                      "<b>Data Producer</b>",
                      "<ul><li>Complete Data Accession request, if data have not been assigned by NASA to the DAAC</li><li>Complete Data Publication request</li><li>Provide updated sample data</li></ul>",
                ...
                },
                {
                   ...
                   "columns":[
                      "<b>DAAC</b>",
                      "<ul><li>Review Data Accession request, if applicable.</li><li>Review Data Publication request</li><li>Assess and plan for data storage needs</li></ul>",
                      ...
                      "<ul><li>Release data product to the public and make it discoverable</li><li>Activate data product DOI and landing page</li><li>Announce the release of data product</li></ul>",
