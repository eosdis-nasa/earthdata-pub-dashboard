...
from your fork into the target branch of the earthdata-pub-dashboard repo
...
2. Repositories - EDPub repositories shall be named `earthdata-pub-thing`,
   for example: `earthdata-pub-forms`, `earthdata-pub-api`.
3. Modules - EDPub core modules will be named "EDPub Thing" where "Thing" is
...
4. Abbreviation - We will use the abbreviation "EDPub" to shorten EDPub, however
